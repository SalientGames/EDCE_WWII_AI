...
namespace ai.player
{
    ...
    //
    public class AlliedAI : AIPlayerData
    {
        ...
        public AlliedAI(int position, string pname, string logpath, string logname, CDLLHints hints,
