...
//
//This class is an interface to talk via strings to the user to report progress
//Used during World Building
//
namespace com.kbs.common.thread
{
    public interface StringPollerI
    {
